...
// Focus:
// - Runner entries
// - Live entries only from scanner HOT runner: SQUEEZE / RUNNING / BREAKOUT + stage=entry
// - Everything else remains shadow/learning-only
// - Partial TP
// - Break-even
// - Trailing stop
// - Optional add
...
// - Cohort learning logs for winner/loser blocking
// - Duplicate exit-notification guard
...
// ================= STRATEGY VERSION =================
// Bewust gebumpt: hot-only live funnel + shadow-only non-hot candidates + exit-spam fix.
const STRATEGY_VERSION = "RUNNER_TS_V1_2_HOT_ONLY_SHADOW_FIX";

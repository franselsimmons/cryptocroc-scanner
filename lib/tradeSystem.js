...
const STRATEGY_VERSION = "RUNNER_TS_V1_3_OPT_SETPOINTS_PRESSURE_COHORT";
...
function maybeLogOptimizerReport(force = false) {
  ...
  const plannedRrOutcomeTable = buildPlannedRrOutcomeTable();
  ...
  console.log("TS_PLANNED_RR_OUTCOME_TABLE", JSON.stringify(plannedRrOutcomeTable));

...
export const SETTINGS = {
  ...
  entry: {
    // ✅ 30m cadence: 4 samples is realistisch binnen 3h
    samplesNeed: 4,
    ...
    // ✅ OB gates minder streng
    obScoreMin: 0.04,
    spreadMaxPct: 1.20,
    depthMinUsd1p: 30_000,

    // ✅ Adaptive tiers (belangrijk voor Depth 1% & spread per marketcap)
    // scan.js pakt dit nu als bron.
    adaptiveTiers: [
    ...
    // ✅ slope minder streng + minder punten nodig
    obSlopeEnabled: true,
    obSlopeMinBull: 0.00035,
    obSlopeMinBear: 0.00035,

    // (optioneel) pro info: geen harde gate, alleen debug
    obSlopeField: "score", // score is standaard
  },
...
/**
 * Slope via lineaire regressie (y over tijd)
 * Output: slope per minuut.
 * 30m cadence: 4 punten is al bruikbaar.
 */
...
export function checkObSlopeGate({ stage, mode, obSamples, settings = SETTINGS }) {
  ...
  // ✅ altijd score gebruiken (sampler schrijft score)

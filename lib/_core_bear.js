...
export const SETTINGS = {
  ...
  almost: {
    minConfidence: 37,           // ⬅ 37
    maxFlat60Pct: 7.5,           // ⬅ 7.5
  },

  // ========== ENTRY – soepeler (aangepast) ==========
  entry: {
    samplesNeed: 2,
    ...
    minAgree: 1,
    minConfidence: 44,           // ⬅ 44 (was 48)
    obScoreMin: 0.028,           // ⬅ 0.028 (was 0.032)
    spreadMaxPct: 1.50,          // ⬅ 1.50 (was 1.35)
    depthMinUsd1p: 16_000,       // ⬅ 16k (was 20k)

    adaptiveTiers: [
      { maxMc: 60_000_000,  minConf: 46, spreadMax: 1.70, depth1pMin: 11_000, obScoreMin: 0.028 },
      { maxMc: 200_000_000, minConf: 44, spreadMax: 1.50, depth1pMin: 16_000, obScoreMin: 0.030 },
      { maxMc: 500_000_000, minConf: 42, spreadMax: 1.30, depth1pMin: 24_000, obScoreMin: 0.034 },
    ],
...
// Voor bear-modus is de fallback "bear"

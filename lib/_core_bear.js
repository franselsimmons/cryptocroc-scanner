...
export const SETTINGS = {
  ...
  // ======================================================
  // RADAR (bear): iets meer tolerant op “bewegend” (bear swings)
  // ======================================================
  radar: {
    mcapMin: 12_000_000,
    mcapMax: 550_000_000, // ✅ bear: iets ruimer (meer short targets)
    volMin: 1_650_000,    // ✅ iets lager voor bear (anders mis je moves)
    vmMin: 0.095,         // ✅ tiny softer

    maxAbsChg24: 42,      // ✅ bear: mag wat extremer
    maxRange24: 62,       // ✅ bear: iets ruimer
  ...
  buildup: {
    minVolAcc: 1.04, // ✅ bear: tiny softer
  },

  almost: {
    minConfidence: 36, // ✅ bear: tiny softer
    maxFlat60Pct: 8.0, // ✅ bear: tiny ruimer
  },

  // ======================================================
  // ENTRY (bear): slope gate blijft, maar iets minder “dood”
  // ======================================================
  entry: {
    samplesNeed: 2,
    ...
    minAgree: 1,
    minConfidence: 39, // ✅ bear: tiny softer
    obScoreMin: 0.0215,
    spreadMaxPct: 1.78,
    depthMinUsd1p: 11_000,

    adaptiveTiers: [
      { maxMc: 60_000_000,  minConf: 45, spreadMax: 1.78, depth1pMin: 10_000, obScoreMin: 0.023 },
      { maxMc: 200_000_000, minConf: 43, spreadMax: 1.58, depth1pMin: 15_000, obScoreMin: 0.025 },
      { maxMc: 550_000_000, minConf: 41, spreadMax: 1.36, depth1pMin: 22_000, obScoreMin: 0.031 },
    ],

    obSlopeEnabled: true,
    obSlopeMinBull: 0.00002,
    obSlopeMinBear: 0.000018, // ✅ bear: tiny easier (anders te vaak fail)
    obSlopeField: "score",
    ...
    dyn: {
      ...
      obScoreHardMin: 0.021,
      obScoreHardMax: 0.072,
    },
  },

  // ======================================================
  // BTC state (bear): sneller “BEAR”, moeilijker “BULL”
  // ======================================================
  btc: {
    softOpenNeutral: true,
    bullMinChg24: 1.25,  // ✅ bull state moeilijker in bear-core
    bearMaxChg24: -0.85, // ✅ bear state makkelijker
  },
};

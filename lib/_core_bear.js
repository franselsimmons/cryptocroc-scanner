...
export const SETTINGS = {
  // ✅ groter universe (wordt gebruikt door jouw universe-builder)
  CG_TOP: 1500, // 6 * 250

  RADAR_LIMIT: 80, // was 60 (iets meer candidates)

  // ========== RADAR ==========
  radar: {
    mcapMin: 10_000_000,     // was 12M (iets ruimer)
    mcapMax: 650_000_000,    // was 500M (iets ruimer)
    volMin: 1_200_000,       // was 1.8M (iets ruimer)
    vmMin: 0.085,            // was 0.10 (iets ruimer)

    maxAbsChg24: 45,         // was 35 (bear moves zijn vaker groot)
    maxRange24: 65,          // was 55
  ...
  entry: {
    ...
    dyn: {
      spreadHardMaxPct: 2.6,   // was 2.4 (iets ruimer)
      spreadHardMinPct: 0.45,
      depthHardMinUsd: 6_000,
      depthHardMaxUsd: 220_000,
      obScoreHardMin: 0.020,   // was 0.022 (iets ruimer)
...
export function dynamicEntryThresholds({ marketCap, volume, vm }, baseThr, settings = SETTINGS) {
  ...
  spreadMaxPct = clamp(
    ...
    Number(dyn.spreadHardMaxPct ?? 2.0)
  );
  ...
  obScoreMin = clamp(
    obScoreMin,
    Number(dyn.obScoreHardMin ?? 0.020),

...
/**
 * BEAR core:
 * - Richting filters zijn bearish (negatieve 1h/24h)
 * - BTC gate is bearish georiënteerd
 * - Entry thresholds iets ruimer voor bear (om niet “0 coins” te krijgen)
 */
export const SETTINGS = {
  ...
  radar: {
    ...
    // bull fields blijven bestaan voor shared code, maar bear gebruikt ze niet
    dir1hMinBull: 0.06,
    dir24MinBull: 0.18,

    // bear direction baseline (dynamicRadarThresholds schaalt dit mee)
    dir1hMaxBear: -0.06,
    dir24MaxBear: -0.18,
  },
  ...
  entry: {
    ...
    obScoreMin: 0.019,
    spreadMaxPct: 1.95,
    depthMinUsd1p: 10_000,

    adaptiveTiers: [
      { maxMc: 60_000_000, minConf: 42, spreadMax: 1.95, depth1pMin: 9_500, obScoreMin: 0.021 },
      { maxMc: 200_000_000, minConf: 40, spreadMax: 1.70, depth1pMin: 14_000, obScoreMin: 0.023 },
      { maxMc: 750_000_000, minConf: 38, spreadMax: 1.45, depth1pMin: 22_000, obScoreMin: 0.028 },
    ],

...
export const SETTINGS = {
  ...
  entry: {
    ...
    obSlopeEnabled: true,
    obSlopeMinBull: 0.015, // verplicht positief
    obSlopeMinBear: 0.015, // (staat hier zodat dezelfde helper ook in bear context kan werken)
  },
 ...
 * We gebruiken samples array met items zoals:
 *   { ts, score, ... }  of  { score, ... }
 */
...
// haalt score-array uit samples (laatste N)
...
/**
 * ✅ Dit is de functie die jij in ALMOST én ENTRY aanroept.
 *
 * - stage: "almost" of "entry" (alleen voor message)
 * - mode: "bull" of "bear"
 * - obSamples: jouw KV samples (array)
 *
 * Return:
 *   { ok: true, slope, scores }
 *   { ok: false, reason, slope, scores }
 */

...
export const SETTINGS = {
  ...
  // ENTRY (BULL – streng voor 80%+ hitrate)
  entry: {
    obScoreMin: 0.07,
    spreadMaxPct: 1.20,
    ...
    minDepthUsd1pBull: 60000,         // depth bull
    minDepthUsd1pBear: 30000,

    minConfidence: 58,                // confidence
    entryConsistencyMin: 0.70,         // consistency
  ...
  // RISK / SLTP (BULL – snellere winstneming)
  risk: {
    slAtrMulBase: 2.20,
    tpAtrMulBase: 2.60,   // lager = hogere hitrate
    slMin: 1.80,
    slMax: 3.00,
    tpMin: 2.20,
    tpMax: 4.20,

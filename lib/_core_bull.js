...
export const SETTINGS = {
  ...
  entry: {
    ...
    adaptiveTiers: [
      { maxMc: 60_000_000,  minConf: 58, spreadMax: 1.30, depth1pMin: 20_000, obScoreMin: 0.040 },
      { maxMc: 200_000_000, minConf: 56, spreadMax: 1.10, depth1pMin: 32_000, obScoreMin: 0.045 },
      { maxMc: 450_000_000, minConf: 54, spreadMax: 0.95, depth1pMin: 50_000, obScoreMin: 0.050 },
    ],

    obSlopeEnabled: true,
    obSlopeMinBull: 0.00025,
    obSlopeMinBear: 0.00025,
    obSlopeField: "score",

    dyn: {
      spreadHardMaxPct: 1.8,
      spreadHardMinPct: 0.50,
      depthHardMinUsd: 10_000,
      depthHardMaxUsd: 160_000,
      obScoreHardMin: 0.035,

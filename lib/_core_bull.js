...
export const SETTINGS = {
  ...
  // ======================================================
  // RADAR (bull): net iets strakker op “quality”
  // ======================================================
  radar: {
    mcapMin: 12_000_000,
    mcapMax: 500_000_000,
  ...
  // ======================================================
  // BTC state (bull): sneller “BULL”, moeilijker “BEAR”
  // ======================================================
  btc: {
    softOpenNeutral: true,
    bullMinChg24: 0.85,  // ✅ bull state makkelijker
    bearMaxChg24: -1.25, // ✅ bear state moeilijker
  },
};

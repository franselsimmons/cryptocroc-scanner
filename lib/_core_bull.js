...
export const SETTINGS = {
  ...
  entry: {
    ...
    // ✅ versoepeld voor smallcaps, maar met extra controle via hogere conf + score
    adaptiveTiers: [
      { maxMc: 50_000_000, minConf: 60, spreadMax: 1.60, depth1pMin: 1_500, obScoreMin: 0.05 },
...
// ✅ analyzer gebruikt dit (geen gokken met SETTINGS-structuur)

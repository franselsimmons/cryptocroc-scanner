...
export const SETTINGS = {
  ...
  // ✅ RADAR = strenger + directioneel (bull-only vanaf start)
  radar: {
    mcapMin: 15_000_000,

    // ✅ PEPE/large caps eruit
    mcapMax: 350_000_000,
  ...
  entry: {
    ...
    obSlopeEnabled: true,
    obSlopeMinBull: 0.00030,
    obSlopeMinBear: 0.00030,
    obSlopeField: "score",
  },

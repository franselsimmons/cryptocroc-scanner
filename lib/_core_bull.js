...
export const SETTINGS = {
  ...
  entry: {
    ...
    adaptiveTiers: [
      ...
      { maxMc: 500_000_000, minConf: 42, spreadMax: 1.30, depth1pMin: 24_000, obScoreMin: 0.032 },
    ],

    obSlopeEnabled: true,
    obSlopeMinBull: 0.00005,
    obSlopeMinBear: 0.00005,
    obSlopeField: "score",

    dyn: {
      spreadHardMaxPct: 2.4,
      spreadHardMinPct: 0.45,
      depthHardMinUsd: 6_000,
      depthHardMaxUsd: 220_000,
      obScoreHardMin: 0.022,

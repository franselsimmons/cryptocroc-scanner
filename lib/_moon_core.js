...
// ========== MOON V2 CONFIGURATIE – VERSOEPELD VOOR MEER ELITE_IGNITION ==========
export const MOON_V2 = {
  bull: {
    ...
    minVmBuildup: 0.18,
    minVmAlmost: 0.28,
    minVmElite: 0.34,               // was 0.40

    minCh1hRadar: -0.8,
    minCh1hBuildup: 0.6,
    minCh1hAlmost: 1.2,
    minCh1hIgnition: 1.7,            // was 2.2
    minCh1hExpansion: 3.2,           // was 3.5

    minCh24Radar: 1.5,
    minCh24Buildup: 4,
    minCh24Almost: 8,
    minCh24Ignition: 10,              // was 12
    minCh24Expansion: 18,              // was 20

    minObBull: 0.025,
    minObStrong: 0.040,               // was 0.055
    spreadMaxRadar: 1.40,
    spreadMaxElite: 1.05,

    maxExhaust24: 85,
    minVelocity: 0.10,
    strongVelocity: 0.16,              // was 0.20
    explosiveVelocity: 0.28,           // was 0.30
  ...
  bear: {
    ...
    maxCh1hBuildup: -0.6,
    maxCh1hAlmost: -1.2,
    maxCh1hIgnition: -1.7,           // was -2.2
    maxCh1hCascade: -3.2,            // was -3.5

    maxCh24Radar: -1.5,
    maxCh24Buildup: -4,
    maxCh24Almost: -8,
    maxCh24Ignition: -10,             // was -12
    maxCh24Cascade: -18,              // was -20

    minObBearAbs: 0.025,
    minObStrongAbs: 0.040,            // was 0.055
    spreadMaxRadar: 1.60,
    spreadMaxElite: 1.20,

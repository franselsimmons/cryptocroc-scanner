...
export function isBlockedMoonAsset(c) {
  ...
  // bijna-stables of nep “moon” assets eruit
...
// ================== BTC – OUDE CACHE (NIET MEER GEBRUIKEN) ==================
const KEY_BTC = "cc:btc:gate";

export async function fetchBTCGateCached() {
  // Deze functie blijft voor compatibiliteit, maar wordt niet meer aangeroepen.
  // Vervang alle aanroepen door fetchBTCGateFromUniverse().
...
export function passRadarMoon(c, mode, btc = null) {
  ...
  if (mode === "bull") {
    ...
    // extra regime boost: bij sterke bull mag 1h iets losser

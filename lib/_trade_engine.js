...
function buildExecutionDecision({
  ...
  const freshEntrySoftOk =
    freshOb ||
    breakoutReady ||
    breakoutPressure >= config.openBreakoutPressureMin + 4;
  ...
  // ======================================================
  // GEEN POSITIE: scanner bepaalt alleen gate
  // ======================================================
  if (!inPosition) {
    if (gate === "IGNORE") {
  ...
  // ======================================================
  // BESTAANDE POSITIE: scanner heeft hier niets meer te zeggen
  // ======================================================

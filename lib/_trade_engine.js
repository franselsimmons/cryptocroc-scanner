...
function buildExecutionDecisionCore({
  ...
  // --------------------------------------------------
  // ENTRY logic
  // Scanner is hoofdpoortwachter.
  // Engine checkt hier alleen execution basics.
  // --------------------------------------------------
  if (!inPosition) {
  ...
  // --------------------------------------------------
  // POSITION logic
  // Engine doet vooral risicobeheer en uitvoering.
  // --------------------------------------------------
  ...
  return {
    ...
    meta: {
      ...
      pnlPct: grossPnlPct,
      netPnlPct,
      reason: "managed_hold_after_weakness",
      weakSignals,
    },
  };
}

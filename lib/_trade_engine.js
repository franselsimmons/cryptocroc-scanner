...
export function buildMainExecutionDecision({
  ...
  checklist.push({
    ...
    need: `≥${THRESHOLDS.main.execution.entryQuality}`,
  });
  ...
  checklist.push({
    ...
    need: `≥${THRESHOLDS.main.execution.persistence}`,
  });
  ...
  checklist.push({
    ...
    need: `ready of ≥${THRESHOLDS.main.execution.breakoutPressure} pressure`,
  });
  ...
  checklist.push({
    ...
    need: `<${THRESHOLDS.main.filters.spread}%`,
  });
...
export function buildMoonExecutionDecision({
  ...
  checklist.push({
    ...
    ok: qualityOk,
    value: entryQuality.toFixed(1),
    need: `≥${THRESHOLDS.moon.execution.entryQuality}`,
  });
  ...
  checklist.push({
    ...
    ok: persistenceOk,
    value: persistence.toFixed(1),
    need: `≥${THRESHOLDS.moon.execution.persistence}`,
  });
  ...
  checklist.push({
    ...
    ok: breakoutSoftOk,
    value: breakoutReady ? "ready" : `${breakoutPressure.toFixed(1)} pressure`,
    need: `ready of ≥${THRESHOLDS.moon.execution.breakoutPressure} pressure`,
  });
  ...
  checklist.push({
    ...
    ok: spreadOk,
    value: `${spread.toFixed(3)}%`,
    need: `<${THRESHOLDS.moon.filters.spread}%`,
  });

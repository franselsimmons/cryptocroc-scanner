...
// ======================================================
// Webhook per funnel (uitgebreid met scan_transition)
// ======================================================
function getDiscordWebhookForFunnel(funnel) {
  switch (String(funnel || "").toLowerCase()) {
    ...
    case "scan_transition":
      return process.env.DISCORD_WEBHOOK_ELITE || ""; // zelfde als elite
    case "trade_tp":
    case "trade_sl":
    case "trade_exit":
      return process.env.DISCORD_WEBHOOK_ELITE || "";
...
// ======================================================
// Formattering per funnel (verbeterd met formatTpSl)
// ======================================================

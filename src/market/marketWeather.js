...
const currentRegime = normalizeWeatherRegime(weather.currentRegime ||
weather.regime);
const currentTrendSide = normalizeWeatherTrendSide(weather.currentTrendSide ||
weather.trendSide || weather.marketTrendSide);
...
trendSide: normalizeWeatherTrendSide(weather.btc?.trendSide ||
weather.btcState)
},
currentFitLabels: currentFitLabels(),
softOnly: true,

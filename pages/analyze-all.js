...
function TopAdjustmentCard({ title, item }) {
  ...
  return (
    ...
    >
      <div style={styles.topCardHead}>
        ...
        <div style={styles.topCardScore}>Score {n(item?.score, 0).toFixed(2)}</div>
      </div>

      <div style={styles.topCardAction}>
        {item?.topAdjustment?.title || "Nog geen harde wijziging"}
      </div>

      <div style={styles.topCardText}>
        {item?.topAdjustment?.shortText || "Nog geen duidelijke eerste aanpassing."}
      </div>
...
function ActionPlan({ group }) {
  ...
  return (
    <div style={styles.panel}>
      <h3 style={styles.h3}>Actieplan</h3>
  ...
  return (
    <section style={styles.section}>
      ...
      {topAdjustment ? (
        ...
        >
          <div style={styles.topBannerLabel}>Eerste aanpassing</div>
          <div style={styles.topBannerTitle}>{topAdjustment.title}</div>
          <div style={styles.topBannerText}>{topAdjustment.longText || topAdjustment.shortText}</div>
        </div>
      ) : null}
      ...
      <div style={styles.twoCol}>
        <LessonList lessons={funnelBlockers?.lessons || []} title="Funnel blocker feedback" />
        <TableBlock
          title="Per reden"
  ...
  return (
    <div style={styles.page}>
      ...
      {!loading && !err && data ? (
        <>
          <section style={styles.section}>
            <h2 style={styles.h2}>Eerste aanpassing per funnel</h2>
            <div style={styles.topGrid}>
              <TopAdjustmentCard title="Trade Funnel" item={overview.trade_funnel} />
              <TopAdjustmentCard title="Moon Bull" item={overview.moon_bull} />
              <TopAdjustmentCard title="Moon Bear" item={overview.moon_bear} />
              <TopAdjustmentCard title="Main Bull" item={overview.main_bull} />
              <TopAdjustmentCard title="Main Bear" item={overview.main_bear} />
            </div>
          </section>

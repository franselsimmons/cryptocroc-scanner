...
export const SETTINGS = {
  ...
  entry: {
    ...
    samplesNeed: 2,
    samplesWindowSec: 900,           // 15 min window (sneller valid)
    minAgree: 2,                      // obAgreeMin

    minDepthUsd1pBull: 60000,
    minDepthUsd1pBear: 60000,         // bear ook dikke depth

    minConfidence: 60,                 // hoger dan bull
    entryConsistencyMin: 0.72,         // strenger dan bull
    ...
    minConfidenceAlmost: 38,
    minConsistencyAlmost: 0.50,
  },

  // RISK / SLTP (zelfde als bull)
  risk: {
    slAtrMulBase: 2.20,
    tpAtrMulBase: 2.60,
    slMin: 1.80,

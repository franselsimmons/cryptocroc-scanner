...
export default async function handler(req, res) {
 ...
 res.setHeader('X-Admin-Micro-Families-Mode', 'long-only-75-child-current-measurement-currentfit-empirical-veto-ranking-flat-null-breadth-seen-ratio-v6');
...
'UNKNOWN'],
     ...
     currentFitPolicy: {
       ...
       polarity: 'bullish market = positive for LONG; bearish market = negative for LONG',
     ...
     rankingPolicy: {
       ...
       activeMode: mode,
       defaultSort:
         'learningQualityRank/adaptiveScore/dashboardBalancedScore/fairWinrate/totalR/avgR/avgCostR/currentFitScore',
       bestDataFirst: true,
...
'learningQualityRank|adaptiveScore|balancedScore|fairWinrate|totalR|avgR|avgCostR',
     ...
     perf: {
       ...
       path:
         'longOnly75ChildCurrentMeasurementGateTriggerBoundaryFillCurrentFitStrictDiscordRankingFlatNullBreadthSeenRatioV6',

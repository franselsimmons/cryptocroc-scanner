...
function sanitizePayload(payload = {}) {
    ...
    return {
         ...
         selectedChildMicroFamilies: sanitizedRotation?.childTrueMicroFamilyIds?.length
|| 0,
...
async function runFreeze({
    ...
    const payload = sanitizePayload({
         ...
         requestedActiveWeekKeyIgnored: requestedActiveWeekKey !==
PERSISTENT_LEARNING_KEY
           ? requestedActiveWeekKey
           : null,
...
state.nextRotation?.childTrueMicroFamilyIds?.length || 0,
...
'LONG_WEEKLY_FREEZE_DISABLED_MANUAL_SELECTION_ONLY_NO_WRITES',
